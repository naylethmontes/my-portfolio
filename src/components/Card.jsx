	...
	return (
		<>
			{cardList.map((card, id) => (
				<div
					key={id}
					className="flex flex-col cursor-pointer bg-red-100 justify-center py-6 px-10 text-center items-center rounded-tl-[35px] rounded-br-[35px] shadow-2xl w-full md:min-h-[340px] min-h-[260px] card-item-div dark:bg-gray-400 text-gray-700 dark:text-gray-300"
				>
