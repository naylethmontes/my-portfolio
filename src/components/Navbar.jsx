...
const Navbar = () => {
	...
	return (
		<header className="overflow-hidden fixed top-0 left-0 w-full bg-opacity-30 backdrop-blur-md z-50 bg-red-400 dark:bg-gray-400 text-gray-800 dark:text-gray-200 dark:bg-opacity-40 ">
				...
				<div className="md:mr-4 flex justify-between w-full ">
					...
					<div className="flex justify-center items-center h-screen">
						<nav className="md:flex hidden items-center space-x-6 text-lg font-medium ">
							...
							<a href="#testimonials" className="hover:text-red-900">
								{t('nav.tests')}
							</a>
			...
			{mobileMenuOpen && (
				<div className="md:hidden ">
					<div className="space-y-1 px-2 pb-3 pt-2 ">
						<a
							href="#"
							className="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-red-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-600"
						>
							{t('nav.home')}
						</a>
						<a
